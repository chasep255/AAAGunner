...
namespace btk::ballistics
{
  ...
  class Simulator
  {
     ...
     * @param dt Maximum time step in s; the final step is shortened to fit max_time (default: 0.001f)
    ...
    // Litz empirical spin-drift displacement:
    // SD(t) = 1.25·(SG+1.2)·t^1.83 inches.
    float computeSpinDriftDisplacement(float t) const;
